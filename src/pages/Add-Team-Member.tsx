        ...
        <form className="w-full h-fit p-5 sm:p-6" onSubmit={handleSubmit}>
          ...
          <div className="w-full bg-white border rounded-lg p-6 mb-4">
            <div className="flex space-x-3 items-center mb-4">
              <p className="py-1 bg-blue-200 px-4 font-semibold rounded-full">
                Member Information
              </p>
            </div>
                ...
                <div className="flex space-x-3">
                  {guestImage ? (
                    <>
                      <label
                        htmlFor="guestImage"
                        className="hover:underline text-yellow-500 cursor-pointer text-sm"
                      >
                        Update
                      </label>
                      <p
                        className="hover:underline text-red-500 cursor-pointer text-sm"
