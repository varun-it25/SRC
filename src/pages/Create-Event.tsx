...
const CreateEvent = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post(`${backendUrl}/create-event`, { event_banner, guest_image, event_name: eventName, event_venue: venue, event_description: description, event_date: eventDate, event_start_time: eventStartTime, event_end_time: eventEndTime, guest_name: guestName, guest_email: guestEmail, guest_mobile_no: guestPhone })
      setLoading(false)
      setStatus('success')
    }
